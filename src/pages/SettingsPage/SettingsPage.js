            ...
            <div className="body-wrapper">
                <div className="body-inner h-100 w-75">
                        ...
                        <div style={{display: 'flex', flexDirection: 'row', marginTop: '10px'}}>
                            ...
                            <div style={{marginLeft: '10px', color: '#2980b9', cursor: 'pointer'}}>
                                <BsFeather onClick={() => {
                                    setShow(true);
                                    setTypeModal('quote');
                                    setTitleOfModal('Изменение цитаты');
                                }}/>
                            </div>
                        </div>
                        <hr/>
                            ...
                            <div style={{marginLeft: '10px', color: '#2980b9', cursor: 'pointer'}}>
                                <div className="form-check form-switch">
                                    <input className="form-check-input" type="checkbox" role="switch"
                                           checked={userInfo.is_public}
                                           id="flexSwitchCheckChecked" onChange={(e) => {
                                        setIsSwitchClicked(true);
                                        SetPublicStatus(e.target.checked);
                                    }} disabled={isSwitchClicked}/>
                                </div>
                            </div>
                        </div>
                        {userInfo.is_public ? (
                                <div style={{display: 'flex', flexDirection: 'row'}}>
                                    <h5> Показывать историю голосования третьим лицам
                                        - {userInfo.show_history ? 'Да' : 'Нет'} </h5>
                                    <div style={{marginLeft: '10px', color: '#2980b9', cursor: 'pointer'}}>
                                        <div className="form-check form-switch">
                                            <input className="form-check-input" type="checkbox" role="switch"
                                                   checked={userInfo.show_history}
                                                   id="flexSwitchCheckChecked" onChange={(e) => {
                                                setIsSwitchClicked(true);
                    ...
                    <div>
                        ...
                        <div style={{display: 'flex', flexDirection: 'row'}}>
                            <h5> Ваша
                                фамилия: {userInfo.last_name !== null ? userInfo.last_name : "Не установлено"} </h5>
                            <div style={{marginLeft: '10px', color: '#2980b9', cursor: 'pointer'}}>
                    ...
                    <hr/>
                    <div>
                        <h4 className="alert-danger" style={{justifyContent: 'center', display: 'flex'}}>Опасная зона</h4>
                        <button className="btn btn-danger" onClick={handleDeleteAccount}>Удалить аккаунт</button>
                    </div>
